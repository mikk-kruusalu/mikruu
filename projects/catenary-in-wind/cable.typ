...
#canvas({
  ...
  content((rel: (0, 0.4), to: E), text(blue, size: 8pt)[$T(x+d x, y+d y)$])
  
  // Gravity/Wind on segment
  line(F, (rel: (0, -0.3), to: F), mark: (end: "straight"), stroke: blue)
  content((rel: (0.2, -0.15), to: F), text(blue, size: 8pt)[$rho g d s$])
  
  line((rel: (-0.4, 0), to: F), (rel: (0.3, 0)), mark: (end: "straight"), stroke: blue)
  content((rel: (-0.4, 0.1), to: F), text(blue, size: 8pt)[$f_w d x$])
})
